...
enum CMD_COMMAND {CMD_HELP,CMD_VERSION,CMD_MULTIPLE_INSTANCE,CMD_NOSPLASH,CMD_MINIMIZED,CMD_SOFTRESET,CMD_HARDRESET,CMD_NO_OPENGL,\
...
static const CMD_STRUCT command_list[]{
    ...
    {CMD_NO_OPENGL,"","no-opengl","Emu64 wird ohne OpenGL Unterstützung gestartet, es wird statt dessen der SDL Renderer verwendet.",0},
    ...
    {CMD_SET_SID_ENGINE,"","set-sid-engine","Setzt die SID Emulations Engine. --set-sid-engine <Engine>\n\t\t\t\t 0=Emu64 1=reSID",1},
